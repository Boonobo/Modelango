...
public class TouchViewHandler {
    ...
    private org.rajawali3d.cameras.Camera camera;

    public TouchViewHandler(Context context, org.rajawali3d.cameras.Camera camera) {
        gestureDetector = new GestureDetector(context, new DragListener());
        scaleGestureDetector = new ScaleGestureDetector(context, new ScaleListener());
        this.camera = camera;
    }

    public org.rajawali3d.cameras.Camera getCamera() {
        return camera;
    }

    public void setCamera(org.rajawali3d.cameras.Camera camera) {
        this.camera = camera;
    }
